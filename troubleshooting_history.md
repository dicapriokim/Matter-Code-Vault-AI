...
* **현재 세션 대화 ID:** `0619ae18-987f-41a4-a958-c42eb1db6bbb`
...
* **[전역 강제 규약 (Global Rule)]**:
  ...
  - **README 정체성 및 무결성 검수 의무**: 깃 푸쉬 전 반드시 `README.md`가 본 프로젝트의 주 목적(Matter 기기 관리/백업 HA 애드온)을 정확하게 설명하고 있는지, 부가기능(로컬 AI 등)이 메인처럼 서술되는 주객전도가 없는지, 외부 가이드 URL이 정확한지 꼼꼼히 재검증해야 합니다.
